 ...
 *
 * NOTE : la version équivalente de ce helper existe aussi dans
 * `packages/mobile-shared/src/lib/absolutize-url.ts` pour l'app
 * mobile-admin (qui consomme déjà le package partagé). Quand on
 * migrera mobile-membre sur `@clubflow/mobile-shared`, on remplacera
 * ce fichier par un thin re-export.
 */
