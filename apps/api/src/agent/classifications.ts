...
export const AGENT_CLASSIFICATIONS: AgentToolClassification[] = [
  ...
  { name: 'clubVitrineArticles', kind: 'query', risk: 'SAFE', description: 'Liste les articles du site vitrine.', allowedRoles: ['CLUB_ADMIN', 'COMM_MANAGER'] },
  ...
  { name: 'createVitrineArticle', kind: 'mutation', risk: 'SAFE', description: "Crée un article vitrine (statut DRAFT par défaut, non publié).", allowedRoles: ['CLUB_ADMIN', 'COMM_MANAGER'] },
